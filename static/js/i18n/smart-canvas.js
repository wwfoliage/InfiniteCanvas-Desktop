(function(){
    ...
    StudioI18n.register({
        ...
        "smart.mediakitLow": { zh: "低码率", en: "Low" },
        "smart.mediakitMedium": { zh: "中码率", en: "Medium" },
        "smart.mediakitHigh": { zh: "高码率", en: "High" },
        ...
        "smart.mediakitSaving": { zh: "增强完成，正在保存到本地…", en: "Enhancement complete. Saving locally…" },
        "smart.mediakitSucceeded": { zh: "增强完成，结果已保存", en: "Enhancement complete and saved" },
        "smart.mediakitSaveFailed": { zh: "云端已完成，但保存到本地失败", en: "Cloud task completed, but local save failed" },
        "smart.mediakitFailed": { zh: "画质增强失败", en: "Video enhancement failed" },
        "smart.mediakitRunning": { zh: "增强中", en: "Enhancing" },
        "smart.mediakitStart": { zh: "开始增强", en: "Start enhancement" },
        "smart.mediakitRetrySave": { zh: "重试保存", en: "Retry save" },
        "smart.mediakitResultFailed": { zh: "增强结果不可用", en: "Enhanced result unavailable" },
        "smart.mediakitResultTitle": { zh: "增强后视频", en: "Enhanced video" },
        "smart.mediakitPreparing": { zh: "正在准备画质增强任务…", en: "Preparing the enhancement task…" },
        "smart.mediakitConfigureKey": { zh: "请先在 API 设置中配置 MediaKit Key", en: "Configure the MediaKit Key in API Settings first" },
        "smart.mediakitQueryFailed": { zh: "查询画质增强任务失败", en: "Failed to query the enhancement task" }
    });
})();
