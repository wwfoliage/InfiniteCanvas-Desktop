(function(){
    ...
    const translations = {
        zh:{
            settingsTitle:'设置',downloads:'下载设置',appearance:'界面设置',language:'语言设置',workflow:'工作流设置',storage:'存储与缓存',about:'关于与更新',
        ...
        en:{
            settingsTitle:'Settings',downloads:'Downloads',appearance:'Appearance',language:'Language',workflow:'Workflow',storage:'Storage & Cache',about:'About & Updates',
